...
public class ChartboostAndroid
{
	...
	// Sets whether Chartboost should use Activities or overlays when displaying adverts. If Activities are used, Chartboost will
	// load a new Activity for each advert shown. Activities will not allow touches to get through to Unity when present.
